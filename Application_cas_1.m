...
## -*- texinfo -*- 
## @deftypefn {} {@var{retval} =} Application_cas_1 (@var{input1}, @var{input2})
##
## @seealso{}
## @end deftypefn
...
function retval = Application_cas_1 (input1, input2)
clear all
clc

L=2; %Longueur des 2 barres
...
Ccn=zeros(N-1,1);
Ccn(1,1)=r*Tc; %Prise en compte de la condition de Dirichlet
Ccn(N-1,1)=r*Tf; %prise en compte de la condition de Dirichlet
