...
## -*- texinfo -*- 
## @deftypefn {} {@var{retval} =} Applications_cas_3 (@var{input1}, @var{input2})
##
## @seealso{}
## @end deftypefn
...
function retval = Applications_cas_3 (input1, input2)
clear all
clc
...
Ccn=zeros(N-1,1);
Ccn(end,1)=2*r*b*dx; %Prise en compte de la condition de Neumann
Ccn(1,1)=r*y; %prise en compte de la condition de Dirichlet
